...
class Settings(BaseSettings):
    ...
    REFRESH_TOKEN_EXPIRE_HOURS: int = Field(24, env="REFRESH_TOKEN_EXPIRE_HOURS")

    # Service Discovery settings
    SERVICE_DISCOVERY_URL: str = Field("http://localhost:8004", env="SERVICE_DISCOVERY_URL")
...
if __name__ == "__main__":
    ...
    print("Refresh Token Expiration (hours):", settings.REFRESH_TOKEN_EXPIRE_HOURS)
