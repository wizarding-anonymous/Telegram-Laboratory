...
class LogicManager:
    ...
    def __init__(
        ...
        self.handlers: Dict[str, Callable[..., Any]] = {
            "text_message": message_handlers._handle_text_message,
            "send_text": message_handlers._handle_send_text,
            "keyboard": keyboard_handlers._handle_keyboard_block,
            "if_condition": flow_handlers._handle_if_condition,
            "loop": flow_handlers._handle_loop_block,
            "api_request": api_handlers._handle_api_request_block,
            "database": api_handlers._handle_database_block,
            "webhook": api_handlers._handle_webhook_block,
            "callback": keyboard_handlers._handle_callback_block,
            "variable": control_handlers._handle_variable_block,
            "photo_message": message_handlers._handle_media_message,
            "video_message": message_handlers._handle_media_message,
            "audio_message": message_handlers._handle_media_message,
            "document_message": message_handlers._handle_media_message,
            "location_message": message_handlers._handle_location_message,
            "sticker_message": message_handlers._handle_media_message,
            "contact_message": message_handlers._handle_contact_message,
            "venue_message": message_handlers._handle_venue_message,
            "game_message": message_handlers._handle_game_message,
            "poll_message": message_handlers._handle_poll_message,
            "send_photo": message_handlers._handle_send_media,
            "send_video": message_handlers._handle_send_media,
            "send_audio": message_handlers._handle_send_media,
            "send_document": message_handlers._handle_send_media,
            "send_location": message_handlers._handle_send_location,
            "send_sticker": message_handlers._handle_send_media,
            "send_contact": message_handlers._handle_send_contact,
            "send_venue": message_handlers._handle_send_venue,
            "send_game": message_handlers._handle_send_game,
            "send_poll": message_handlers._handle_send_poll,
            "try_catch": control_handlers._handle_try_catch_block,
            "raise_error": control_handlers._handle_raise_error_block,
            "handle_exception": control_handlers._handle_handle_exception_block,
            "log_message": control_handlers._handle_log_message,
            "timer": control_handlers._handle_timer_block,
            "state_machine": flow_handlers._handle_state_machine_block,
            "custom_filter": flow_handlers._handle_custom_filter_block,
            "rate_limiting": control_handlers._handle_rate_limiting_block,
        }
