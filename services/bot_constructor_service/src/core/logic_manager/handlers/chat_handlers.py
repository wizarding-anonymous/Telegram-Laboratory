...
class ChatHandler:
    ...
    @handle_exceptions
    async def handle_get_chat_members(self, block: Dict[str, Any], chat_id: int, variables: Dict[str,Any]) -> List[Dict[str,Any]]:
        """
    ...
    @handle_exceptions
    async def handle_ban_user(self, block: Dict[str, Any], chat_id: int, variables: Dict[str,Any]) -> None:
        """
    ...
    @handle_exceptions
    async def handle_unban_user(self, block: Dict[str, Any], chat_id: int, variables: Dict[str,Any]) -> None:
        """
    ...
    @handle_exceptions
    async def handle_set_chat_title(self, block: Dict[str, Any], chat_id: int, variables: Dict[str,Any]) -> None:
        """
        ...
        await self.telegram_client.set_chat_title(chat_id=chat_id, title=rendered_title)



    @handle_exceptions
    async def handle_set_chat_description(self, block: Dict[str, Any], chat_id: int, variables: Dict[str,Any]) -> None:
         """
         ...
         await self.telegram_client.set_chat_description(chat_id=chat_id, description=rendered_description)



    @handle_exceptions
    async def handle_pin_message(self, block: Dict[str, Any], chat_id: int, variables: Dict[str,Any]) -> None:
        """
        ...
        validate_chat_id(chat_id)
        await self.telegram_client.pin_chat_message(chat_id=chat_id, message_id=message_id)


    @handle_exceptions
    async def handle_unpin_message(self, block: Dict[str, Any], chat_id: int, variables: Dict[str,Any]) -> None:
        """
        ...
        message_id = block.get("content", {}).get("message_id")
        validate_chat_id(chat_id)
        await self.telegram_client.unpin_chat_message(chat_id=chat_id, message_id=message_id)
